...
impl Game {
    ...
    fn simulate(&mut self, mut alpha: i32, beta: i32, depth: usize, color: i32) -> (i32, Option<(usize, usize, usize, usize)>) {
    ...
    fn calculate_move(&mut self, _my_time: i32, _opp_time: i32) -> Option<(usize, usize, usize, usize)> {
